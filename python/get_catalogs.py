...
if os.path.exists(GaiaTable):
    ...
    print(" - Downloaded GAIA-DR2 catalog with " + str(len(gaia_cat)) + ' sources')
...
if os.path.exists(WiseTable):
    ...
    print("  ==> Wrote ALLWISE catalog to ", WiseTable)
...
print("  ==> Wrote merged Gaia-WISE catalog with {:} sources".format(len(goodStars)))
#fix a bug in the ipac table writer
...
## 
##     print("   - Writing 2MASS catalog with {:} sources ...".format(len(twomass_cat)))
...
## print("  - Wrote merged 2MASS-WISE catalog to ", TwomassStarTable)
## #fix a bug in the ipac table writer
